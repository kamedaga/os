...
enum {
    ...
    LPRS_OP_PROCESS_EXEC_COMMIT_DONE = 10u,
    LPRS_OP_PROCESS_WAIT4 = 11u,
    LPRS_OP_PROCESS_SETPGID = 12u,
    LPRS_OP_PROCESS_SETSID = 13u,
    LPRS_OP_PROCESS_GETPGID = 14u,
    LPRS_OP_PROCESS_GETSID = 15u,
    LPRS_OP_PROCESS_SET_PDEATHSIG = 16u,
    LPRS_OP_PROCESS_GET_PDEATHSIG = 17u,

    LPRS_OP_SIGNAL_KILL = 18u,
    LPRS_OP_SIGNAL_DELIVER_TTY = 19u,

    LPRS_OP_CWD_GET = 20u,
    LPRS_OP_CWD_SET = 21u,

    LPRS_OP_DIAG_DUMP = 22u,
    LPRS_OP_DIAG_ERROR_GET = 23u,
