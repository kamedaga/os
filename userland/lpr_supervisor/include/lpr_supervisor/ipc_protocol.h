...
enum {
    ...
    LPRS_OP_PROCESS_FORK_BEGIN = 4u,
    LPRS_OP_PROCESS_FORK_PARENT_REGISTER = 5u,
    LPRS_OP_PROCESS_FORK_CHILD_READY = 6u,
    LPRS_OP_PROCESS_EXEC_COMMIT_BEGIN = 7u,
    LPRS_OP_PROCESS_EXEC_COMMIT_DONE = 8u,
    LPRS_OP_PROCESS_WAIT4 = 9u,
    LPRS_OP_PROCESS_SETPGID = 10u,
    LPRS_OP_PROCESS_SETSID = 11u,
    LPRS_OP_PROCESS_GETPGID = 12u,
    LPRS_OP_PROCESS_GETSID = 13u,

    LPRS_OP_SIGNAL_KILL = 14u,
    LPRS_OP_SIGNAL_DELIVER_TTY = 15u,

    LPRS_OP_CWD_GET = 16u,
    LPRS_OP_CWD_SET = 17u,

    LPRS_OP_DIAG_DUMP = 18u,
    LPRS_OP_DIAG_ERROR_GET = 19u,
...
_Static_assert(sizeof(lprs_process_state_t) == 608, "lprs_process_state size");
