...
enum {
    ...
    LPRS_OP_PROCESS_FORK_CANCEL = 5u,
    LPRS_OP_PROCESS_FORK_PARENT_REGISTER = 6u,
    LPRS_OP_PROCESS_FORK_CHILD_READY = 7u,
    LPRS_OP_PROCESS_EXEC_COMMIT_BEGIN = 8u,
    LPRS_OP_PROCESS_EXEC_COMMIT_DONE = 9u,
    LPRS_OP_PROCESS_WAIT4 = 10u,
    LPRS_OP_PROCESS_SETPGID = 11u,
    LPRS_OP_PROCESS_SETSID = 12u,
    LPRS_OP_PROCESS_GETPGID = 13u,
    LPRS_OP_PROCESS_GETSID = 14u,

    LPRS_OP_SIGNAL_KILL = 15u,
    LPRS_OP_SIGNAL_DELIVER_TTY = 16u,

    LPRS_OP_CWD_GET = 17u,
    LPRS_OP_CWD_SET = 18u,

    LPRS_OP_DIAG_DUMP = 19u,
    LPRS_OP_DIAG_ERROR_GET = 20u,
