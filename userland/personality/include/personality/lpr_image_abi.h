...
#define LPR_BOOTSTRAP_FD_DEVICE 2u
#define LPR_BOOTSTRAP_FD_TTY 3u
#define LPR_BOOTSTRAP_FD_DRM 4u
#define LPR_BOOTSTRAP_FD_INPUT 5u
#define LPR_BOOTSTRAP_FD_PIPE 6u
#define LPR_BOOTSTRAP_FD_EVENT 7u
#define LPR_BOOTSTRAP_FD_SOCKET 8u
#define LPR_BOOTSTRAP_FD_NATIVE 9u
#define LPR_BOOTSTRAP_FD_DMABUF 10u
