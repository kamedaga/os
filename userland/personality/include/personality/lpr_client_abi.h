...
enum {
    ...
    LPR_CLIENT_FD_KIND_GPUD_DRM_HANDLE = 3u,
    LPR_CLIENT_FD_KIND_INPUTD_HANDLE = 4u,
    LPR_CLIENT_FD_KIND_PIPE = 5u,
    LPR_CLIENT_FD_KIND_EVENT = 6u,
    LPR_CLIENT_FD_KIND_SOCKET = 7u,
