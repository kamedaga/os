...
#define LPR_LINUX_O_LARGEFILE 00100000ull
...
int lpr_exec_copy_string_vector( filed_exec_path_t *exec, filed_exec_string_ref_t *refs, uint64_t max_refs, uint64_t vector_raw, uint64_t *out_count);
