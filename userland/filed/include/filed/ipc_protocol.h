...
enum {
    ...
    FILED_OP_HELLO = 0u,
    FILED_OP_CLIENT_REGISTER = 1u,
    FILED_OP_CLIENT_CREDENTIALS = 2u,

    FILED_OP_SESSION_OPEN = 3u,
    FILED_OP_SESSION_CLOSE = 4u,
    FILED_OP_SESSION_DOORBELL = 5u,

    FILED_OP_VFS_ROOT_STAT = 6u,
    FILED_OP_VFS_ROOT_GETDENTS = 7u,
    FILED_OP_VFS_OPENAT = 8u,
    FILED_OP_VFS_VALIDATE_OPEN_CACHE = 9u,
    FILED_OP_VFS_STAT = 10u,
    FILED_OP_VFS_STATAT = 11u,
    FILED_OP_VFS_STATFS = 12u,
    FILED_OP_VFS_READ = 13u,
    FILED_OP_VFS_PREAD = 14u,
    FILED_OP_VFS_WRITE = 15u,
    FILED_OP_VFS_PWRITE = 16u,
    FILED_OP_VFS_WRITE_BATCH = 17u,
    FILED_OP_VFS_PWRITE_BATCH = 18u,
    FILED_OP_VFS_GETDENTS = 19u,
    FILED_OP_VFS_SEEK = 20u,
    FILED_OP_VFS_CLOSE = 21u,
    FILED_OP_VFS_DUP = 22u,
    FILED_OP_VFS_TRANSFER_DUP = 23u,
    FILED_OP_VFS_GET_FLAGS = 24u,
    FILED_OP_VFS_SET_FLAGS = 25u,
    FILED_OP_VFS_FSYNC = 26u,
    FILED_OP_VFS_TRUNCATE = 27u,
    FILED_OP_VFS_UNLINK = 28u,
    FILED_OP_VFS_RENAME = 29u,
    FILED_OP_VFS_MKDIR = 30u,
    FILED_OP_VFS_MKNOD = 31u,
    FILED_OP_VFS_RMDIR = 32u,
    FILED_OP_VFS_SYMLINK = 33u,
    FILED_OP_VFS_READLINK = 34u,
    FILED_OP_VFS_LINK = 35u,
    FILED_OP_VFS_FILE_VMO = 36u,
    FILED_OP_VFS_PREAD_TO_VMO = 37u,
    FILED_OP_VFS_SYNC_ALL = 38u,
    FILED_OP_VFS_UTIMENS = 39u,
    FILED_OP_VFS_CHMOD = 40u,
    FILED_OP_VFS_SHARED_FILE_VMO = 41u,
    FILED_OP_VFS_MEMFD_CREATE = 42u,

    FILED_OP_EXEC_PATH = 43u,
    FILED_OP_EXEC_SELF = 44u,

    FILED_OP_SERVICE_SET_NETD_SOCKET = 45u,
    FILED_OP_SERVICE_SET_TERMD_TTY = 46u,
    FILED_OP_SERVICE_SET_DRMD_DRM = 47u,
    FILED_OP_SERVICE_SET_INPUTD_INPUT = 48u,
    FILED_OP_SERVICE_REGISTER_TERMD_SIGNAL_SUPERVISOR = 49u,

    FILED_OP_DIAG_PING = 50u,
    FILED_OP_DIAG_DUMP = 51u,
    FILED_OP_DIAG_ERROR_GET = 52u,
    FILED_OP_DIAG_DUMP_METRICS = 53u,
    FILED_OP_DIAG_SET_CACHE_SLOTS = 54u,
