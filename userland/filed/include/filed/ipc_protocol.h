...
enum {
    ...
    FILED_OP_SERVICE_REGISTER_TERMD_SIGNAL_SUPERVISOR = 42u,

    FILED_OP_DIAG_PING = 43u,
    FILED_OP_DIAG_DUMP = 44u,
    FILED_OP_DIAG_ERROR_GET = 45u,
    FILED_OP_DIAG_DUMP_METRICS = 46u,
    FILED_OP_DIAG_SET_CACHE_SLOTS = 47u,
