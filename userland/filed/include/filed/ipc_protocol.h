...
enum {
    ...
    FILED_OP_VFS_MKNOD = 26u,
    FILED_OP_VFS_RMDIR = 27u,
    FILED_OP_VFS_SYMLINK = 28u,
    FILED_OP_VFS_READLINK = 29u,
    FILED_OP_VFS_LINK = 30u,
    FILED_OP_VFS_FILE_VMO = 31u,
    FILED_OP_VFS_PREAD_TO_VMO = 32u,
    FILED_OP_VFS_SYNC_ALL = 33u,
    FILED_OP_VFS_UTIMENS = 34u,
    FILED_OP_VFS_CHMOD = 35u,
    FILED_OP_VFS_SHARED_FILE_VMO = 36u,
    FILED_OP_VFS_MEMFD_CREATE = 37u,

    FILED_OP_EXEC_PATH = 38u,
    FILED_OP_EXEC_SELF = 39u,

    FILED_OP_SERVICE_SET_NETD_SOCKET = 40u,
    FILED_OP_SERVICE_SET_TERMD_TTY = 41u,
    FILED_OP_SERVICE_SET_DRMD_DRM = 42u,
    FILED_OP_SERVICE_SET_INPUTD_INPUT = 43u,
    FILED_OP_SERVICE_REGISTER_TERMD_SIGNAL_SUPERVISOR = 44u,

    FILED_OP_DIAG_PING = 45u,
    FILED_OP_DIAG_DUMP = 46u,
    FILED_OP_DIAG_ERROR_GET = 47u,
    FILED_OP_DIAG_DUMP_METRICS = 48u,
    FILED_OP_DIAG_SET_CACHE_SLOTS = 49u,
