...
enum {
    ...
    FILED_OP_SERVICE_REGISTER_TERMD_SIGNAL_SUPERVISOR = 41u,

    FILED_OP_DIAG_PING = 42u,
    FILED_OP_DIAG_DUMP = 43u,
    FILED_OP_DIAG_ERROR_GET = 44u,
    FILED_OP_DIAG_DUMP_METRICS = 45u,
    FILED_OP_DIAG_SET_CACHE_SLOTS = 46u,
