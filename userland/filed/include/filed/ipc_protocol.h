...
enum {
    ...
    FILED_OP_VFS_TRANSFER_DUP = 19u,
    FILED_OP_VFS_GET_FLAGS = 20u,
    FILED_OP_VFS_SET_FLAGS = 21u,
    FILED_OP_VFS_FSYNC = 22u,
    FILED_OP_VFS_TRUNCATE = 23u,
    FILED_OP_VFS_UNLINK = 24u,
    FILED_OP_VFS_RENAME = 25u,
    FILED_OP_VFS_MKDIR = 26u,
    FILED_OP_VFS_MKNOD = 27u,
    FILED_OP_VFS_RMDIR = 28u,
    FILED_OP_VFS_SYMLINK = 29u,
    FILED_OP_VFS_READLINK = 30u,
    FILED_OP_VFS_LINK = 31u,
    FILED_OP_VFS_FILE_VMO = 32u,
    FILED_OP_VFS_PREAD_TO_VMO = 33u,
    FILED_OP_VFS_SYNC_ALL = 34u,
    FILED_OP_VFS_UTIMENS = 35u,
    FILED_OP_VFS_CHMOD = 36u,
    FILED_OP_VFS_SHARED_FILE_VMO = 37u,
    FILED_OP_VFS_MEMFD_CREATE = 38u,

    FILED_OP_EXEC_PATH = 39u,
    FILED_OP_EXEC_SELF = 40u,

    FILED_OP_SERVICE_SET_NETD_SOCKET = 41u,
    FILED_OP_SERVICE_SET_TERMD_TTY = 42u,
    FILED_OP_SERVICE_SET_DRMD_DRM = 43u,
    FILED_OP_SERVICE_SET_INPUTD_INPUT = 44u,
    FILED_OP_SERVICE_REGISTER_TERMD_SIGNAL_SUPERVISOR = 45u,

    FILED_OP_DIAG_PING = 46u,
    FILED_OP_DIAG_DUMP = 47u,
    FILED_OP_DIAG_ERROR_GET = 48u,
    FILED_OP_DIAG_DUMP_METRICS = 49u,
    FILED_OP_DIAG_SET_CACHE_SLOTS = 50u,
