...
enum {
    ...
    FILED_OP_VFS_STATAT = 9u,
    FILED_OP_VFS_STATFS = 10u,
    FILED_OP_VFS_READ = 11u,
    FILED_OP_VFS_PREAD = 12u,
    FILED_OP_VFS_WRITE = 13u,
    FILED_OP_VFS_PWRITE = 14u,
    FILED_OP_VFS_WRITE_BATCH = 15u,
    FILED_OP_VFS_PWRITE_BATCH = 16u,
    FILED_OP_VFS_GETDENTS = 17u,
    FILED_OP_VFS_SEEK = 18u,
    FILED_OP_VFS_CLOSE = 19u,
    FILED_OP_VFS_DUP = 20u,
    FILED_OP_VFS_TRANSFER_DUP = 21u,
    FILED_OP_VFS_GET_FLAGS = 22u,
    FILED_OP_VFS_SET_FLAGS = 23u,
    FILED_OP_VFS_FSYNC = 24u,
    FILED_OP_VFS_TRUNCATE = 25u,
    FILED_OP_VFS_UNLINK = 26u,
    FILED_OP_VFS_RENAME = 27u,
    FILED_OP_VFS_MKDIR = 28u,
    FILED_OP_VFS_MKNOD = 29u,
    FILED_OP_VFS_RMDIR = 30u,
    FILED_OP_VFS_SYMLINK = 31u,
    FILED_OP_VFS_READLINK = 32u,
    FILED_OP_VFS_LINK = 33u,
    FILED_OP_VFS_FILE_VMO = 34u,
    FILED_OP_VFS_PREAD_TO_VMO = 35u,
    FILED_OP_VFS_SYNC_ALL = 36u,
    FILED_OP_VFS_UTIMENS = 37u,
    FILED_OP_VFS_CHMOD = 38u,
    FILED_OP_VFS_SHARED_FILE_VMO = 39u,
    FILED_OP_VFS_MEMFD_CREATE = 40u,

    FILED_OP_EXEC_PATH = 41u,
    FILED_OP_EXEC_SELF = 42u,

    FILED_OP_SERVICE_SET_NETD_SOCKET = 43u,
    FILED_OP_SERVICE_SET_TERMD_TTY = 44u,
    FILED_OP_SERVICE_SET_DRMD_DRM = 45u,
    FILED_OP_SERVICE_SET_INPUTD_INPUT = 46u,
    FILED_OP_SERVICE_REGISTER_TERMD_SIGNAL_SUPERVISOR = 47u,

    FILED_OP_DIAG_PING = 48u,
    FILED_OP_DIAG_DUMP = 49u,
    FILED_OP_DIAG_ERROR_GET = 50u,
    FILED_OP_DIAG_DUMP_METRICS = 51u,
    FILED_OP_DIAG_SET_CACHE_SLOTS = 52u,
