...
enum {
    ...
    FILED_OP_VFS_STATFS = 9u,
    FILED_OP_VFS_READ = 10u,
    FILED_OP_VFS_PREAD = 11u,
    FILED_OP_VFS_WRITE = 12u,
    FILED_OP_VFS_PWRITE = 13u,
    FILED_OP_VFS_WRITE_BATCH = 14u,
    FILED_OP_VFS_PWRITE_BATCH = 15u,
    FILED_OP_VFS_GETDENTS = 16u,
    FILED_OP_VFS_SEEK = 17u,
    FILED_OP_VFS_CLOSE = 18u,
    FILED_OP_VFS_DUP = 19u,
    FILED_OP_VFS_TRANSFER_DUP = 20u,
    FILED_OP_VFS_GET_FLAGS = 21u,
    FILED_OP_VFS_SET_FLAGS = 22u,
    FILED_OP_VFS_FSYNC = 23u,
    FILED_OP_VFS_TRUNCATE = 24u,
    FILED_OP_VFS_UNLINK = 25u,
    FILED_OP_VFS_RENAME = 26u,
    FILED_OP_VFS_MKDIR = 27u,
    FILED_OP_VFS_MKNOD = 28u,
    FILED_OP_VFS_RMDIR = 29u,
    FILED_OP_VFS_SYMLINK = 30u,
    FILED_OP_VFS_READLINK = 31u,
    FILED_OP_VFS_LINK = 32u,
    FILED_OP_VFS_FILE_VMO = 33u,
    FILED_OP_VFS_PREAD_TO_VMO = 34u,
    FILED_OP_VFS_SYNC_ALL = 35u,
    FILED_OP_VFS_UTIMENS = 36u,
    FILED_OP_VFS_CHMOD = 37u,
    FILED_OP_VFS_SHARED_FILE_VMO = 38u,
    FILED_OP_VFS_MEMFD_CREATE = 39u,

    FILED_OP_EXEC_PATH = 40u,
    FILED_OP_EXEC_SELF = 41u,

    FILED_OP_SERVICE_SET_NETD_SOCKET = 42u,
    FILED_OP_SERVICE_SET_TERMD_TTY = 43u,
    FILED_OP_SERVICE_SET_DRMD_DRM = 44u,
    FILED_OP_SERVICE_SET_INPUTD_INPUT = 45u,
    FILED_OP_SERVICE_REGISTER_TERMD_SIGNAL_SUPERVISOR = 46u,

    FILED_OP_DIAG_PING = 47u,
    FILED_OP_DIAG_DUMP = 48u,
    FILED_OP_DIAG_ERROR_GET = 49u,
    FILED_OP_DIAG_DUMP_METRICS = 50u,
    FILED_OP_DIAG_SET_CACHE_SLOTS = 51u,
