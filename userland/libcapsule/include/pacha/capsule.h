...
enum {
    ...
    PACHA_CAPSULE_SYSCALL_QUERY = 47,
    PACHA_CAPSULE_SYSCALL_DERIVE_MMIO = 48,
    PACHA_CAPSULE_SYSCALL_DERIVE_DMA_BUFFER = 49,
    PACHA_CAPSULE_SYSCALL_DERIVE_DMA_MAPPING = 50,
    PACHA_CAPSULE_SYSCALL_DERIVE_DMA_MAPPING_FROM_BUFFER = 51,
    PACHA_CAPSULE_SYSCALL_DERIVE_IRQ = 52,
    PACHA_CAPSULE_SYSCALL_PCI_CONFIG_READ = 53,
    PACHA_CAPSULE_SYSCALL_PCI_CONFIG_WRITE = 54,
    PACHA_CAPSULE_SYSCALL_PCI_BAR_INFO = 55,
    PACHA_CAPSULE_SYSCALL_IRQ_POLL = 56,
