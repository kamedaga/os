...
enum {
    ...
    PACHAOS_SYSCALL_MMAP = 47,
    PACHAOS_SYSCALL_MUNMAP = 48,
    PACHAOS_SYSCALL_IPC_CHANNEL_CREATE = 53,
    PACHAOS_SYSCALL_IPC_SEND = 54,
    PACHAOS_SYSCALL_IPC_RECV = 55,
    PACHAOS_SYSCALL_IPC_CALL = 56,
    PACHAOS_SYSCALL_IPC_RECV_WAIT = 58,
