...
enum {
    PACHAOS_SYSCALL_FD_CLOSE = 37,
    PACHAOS_SYSCALL_FD_WAIT_MANY = 47,
    PACHAOS_SYSCALL_VMO_CREATE = 55,
    PACHAOS_SYSCALL_MMAP = 59,
    PACHAOS_SYSCALL_MUNMAP = 60,
    PACHAOS_SYSCALL_IPC_CHANNEL_CREATE = 65,
    PACHAOS_SYSCALL_IPC_SEND = 66,
    PACHAOS_SYSCALL_IPC_RECV = 67,
    PACHAOS_SYSCALL_IPC_CALL = 68,
    PACHAOS_SYSCALL_IPC_RECV_WAIT = 70,
