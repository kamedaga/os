...
enum {
    PACHAOS_SYSCALL_FD_CLOSE = 21,
    PACHAOS_SYSCALL_FD_WAIT_MANY = 31,
    PACHAOS_SYSCALL_VMO_CREATE = 38,
    PACHAOS_SYSCALL_MMAP = 39,
    PACHAOS_SYSCALL_MUNMAP = 40,
    PACHAOS_SYSCALL_IPC_CHANNEL_CREATE = 43,
    PACHAOS_SYSCALL_IPC_SEND = 44,
    PACHAOS_SYSCALL_IPC_RECV = 45,
    PACHAOS_SYSCALL_IPC_CALL = 46,
    PACHAOS_SYSCALL_IPC_RECV_WAIT = 48,
