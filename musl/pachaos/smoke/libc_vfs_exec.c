...
enum {
    ...
    PACHAOS_SYSCALL_MMAP = 56,
    PACHAOS_SYSCALL_MUNMAP = 57,
    PACHAOS_SYSCALL_IPC_CHANNEL_CREATE = 62,
    PACHAOS_SYSCALL_IPC_SEND = 63,
    PACHAOS_SYSCALL_IPC_RECV = 64,
    PACHAOS_SYSCALL_IPC_CALL = 65,
    PACHAOS_SYSCALL_IPC_RECV_WAIT = 67,
