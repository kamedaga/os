...
output="$root_dir/.artifacts/userland-fixtures/uutils-coreutils-common.elf"
target="x86_64-unknown-linux-musl"
expected_sha256="5f0c3f97b807e72edccc844c6a685ec9862199f16a665df07de5b1d20ec21233"
features="chmod cp cut date dd env head id ln mkdir mktemp mv nproc printf readlink realpath rm rmdir seq sleep sort stat tail tee touch tr uname uniq wc whoami yes"
