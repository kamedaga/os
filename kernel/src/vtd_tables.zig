...
pub const iova_window_start = @import("iova.zig").window_start;
// Kernel-chosen addresses retain the existing 32-bit caller contract. Actual
// device apertures are clipped against boot-time hardware reservations.
pub const iova_window_end = @import("iova.zig").window_ceiling;
pub const IovaAllocator = @import("iova.zig").Allocator;
pub const IovaTestStorage = @import("iova.zig").TestStorage;
