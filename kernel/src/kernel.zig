...
pub const native_cow_table_slots_per_chunk = types.native_cow_table_slots_per_chunk;
...
pub const NativeCowTableChunk = types.NativeCowTableChunk;
...
pub const NativeVmaPrepareKind = types.NativeVmaPrepareKind;
pub const NativeVmaFaultPlan = types.NativeVmaFaultPlan;
...
pub const KernelState = struct {
    ...
    native_cow_table_initial: NativeCowTableChunk = .{},
    native_cow_table_overflow_head: ?*NativeCowTableChunk = null,
    native_cow_table_chunk_count: usize = 1,
    ...
    pub const pipeWritableReady = pipe_state.pipeWritableReady;
    pub const pipeWritableReadyForBytes = pipe_state.pipeWritableReadyForBytes;
    ...
    pub const irqPublishedEventPending = fd_state.irqPublishedEventPending;
    pub const acknowledgeIrqEventCountForFd = fd_state.acknowledgeIrqEventCountForFd;
    ...
    pub const detachForkChildDirtyCowTables = vma_state.detachForkChildDirtyCowTables;
    ...
    pub const prepareNativeVmaFaultMapping = vma_state.prepareNativeVmaFaultMapping;
    pub const commitNativeVmaFaultMapping = vma_state.commitNativeVmaFaultMapping;
    ...
    pub const prepareNativeVmaCowMapping = vma_state.prepareNativeVmaCowMapping;
    pub const commitNativeVmaCowMapping = vma_state.commitNativeVmaCowMapping;
    pub const nativeVmaCowPlanSourceIsCurrent = vma_state.nativeVmaCowPlanSourceIsCurrent;
    pub const ensureNativeVmaCowMappingLockedSlow = vma_state.ensureNativeVmaCowMappingLockedSlow;
    ...
    pub const fdPollEventsWithWriteMin = fd_state.fdPollEventsWithWriteMin;
    ...
    pub const processObjectTargetsCurrentGeneration = process_state.processObjectTargetsCurrentGeneration;
    ...
    pub const createProcessDescriptorWithCapacityLimit = process_state.createProcessDescriptorWithCapacityLimit;
    pub const createProcessDescriptorWithCapacityLimitChecked = process_state.createProcessDescriptorWithCapacityLimitChecked;
