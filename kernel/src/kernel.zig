...
pub const NativeVmaDmaPackPlan = types.NativeVmaDmaPackPlan;
...
pub const KernelState = struct {
    ...
    pub const replaceNativeVmoPagesIfCurrent = vmo_state.replaceNativeVmoPagesIfCurrent;
    ...
    pub const prepareNativeVmaDmaPack = vma_state.prepareNativeVmaDmaPack;
