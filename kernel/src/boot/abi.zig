...
pub const boot_manifest_abi = abi_root.boot_manifest_abi;
pub const boot_status_abi = abi_root.boot_status_abi;
pub const cap_transfer_abi = abi_root.cap_transfer_abi;
